...
<nav id="slide-menu">
	...
	<ul>
		<li class="timeline"><a href="/Website/admin_page.php">Dashboard</a></li>
...
<div id="content">
  ...
  <div class="intro">
    <p style="color:#000000">
      ...
      $sql = $connect->prepare("SELECT name from teacher_details where ID = ?");
      $sql->bind_param("s",$id);
...
<div class="card_main">
  ...
  <div class="container">
    <b><a href="/Website/Dashboard/notifications.php" >Notifications</a></b> 
  </div>
</div>
...
<div class="card" style="border-color: #8BC34A;">
  ...
  <div class="container">
    <b style="color: #8BC34A;"><a href="/Website/Dashboard/pending.php" >Pending</a></b> 
  </div>
</div>
